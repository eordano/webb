define(['exports'], function (exports) { 'use strict';
            ...
            */
            ...
            var EC_PRIVKEY_EXPORT_DER_COMPRESSED = Buffer$2.from([
              // begin
            ...
            var EC_PRIVKEY_EXPORT_DER_UNCOMPRESSED = Buffer$2.from([
              // begin
            ...
            var privateKeyExport = function (privateKey, publicKey, compressed) {
              var result = Buffer$2.from(compressed ? EC_PRIVKEY_EXPORT_DER_COMPRESSED : EC_PRIVKEY_EXPORT_DER_UNCOMPRESSED);
            ...
            var signatureExport = function (sigObj) {
              var r = Buffer$2.concat([Buffer$2.from([0]), sigObj.r]);
              for (var lenR = 33, posR = 0; lenR > 1 && r[posR] === 0x00 && !(r[posR + 1] & 0x80); --lenR, ++posR);

              var s = Buffer$2.concat([Buffer$2.from([0]), sigObj.s]);
            ...
            var signatureImport = function (sig) {
              var r = Buffer$2.alloc(32, 0);
              var s = Buffer$2.alloc(32, 0);
            ...
            MD5.prototype._digest = function () {
              ...
              // produce result
              var buffer = Buffer$4.allocUnsafe(16);
            ...
            RIPEMD160.prototype._digest = function () {
              ...
              // produce result
              var buffer = Buffer$5.alloc ? Buffer$5.alloc(20) : new Buffer$5(20);
              buffer.writeInt32LE(this._a, 0);
              buffer.writeInt32LE(this._b, 4);
              buffer.writeInt32LE(this._c, 8);
              buffer.writeInt32LE(this._d, 12);
            ...
            CipherBase.prototype.update = function (data, inputEnc, outputEnc) {
              if (typeof data === 'string') {
                data = Buffer$d.from(data, inputEnc);
              }
            ...
            CipherBase.prototype._finalOrDigest = function (outputEnc) {
              var outData = this.__final() || Buffer$d.alloc(0);
              if (outputEnc) {
            ...
            */
            ...
            const { privateKeyVerify, sign, publicKeyCreate } = elliptic$1;
            window['assert'] = assert$b;
