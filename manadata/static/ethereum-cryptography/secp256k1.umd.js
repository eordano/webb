(function (global, factory) {
	...
	(global = global || self, factory(global['ethereum-cryptography/sha256'] = {}, global.buffer, global.EventEmitter, global.util));
}(this, (function (exports, buffer, EventEmitter, util) { 'use strict';

	var buffer__default = 'default' in buffer ? buffer['default'] : buffer;
	var EventEmitter__default = 'default' in EventEmitter ? EventEmitter['default'] : EventEmitter;
	...
	*/
	function encode (r, s) {
	  ...
	  var signature = Buffer$1.allocUnsafe(6 + lenR + lenS);
	...
	var isBufferEncoding = buffer.Buffer.isEncoding
	  || function(encoding) {
	...
	function StringDecoder(encoding) {
	  ...
	  this.charBuffer = new buffer.Buffer(6);
	...
	util.inherits(Readable, EventEmitter__default);
	...
	function Readable(options) {
	  ...
	  EventEmitter__default.call(this);
	}
	...
	Readable.prototype.on = function (ev, fn) {
	  var res = EventEmitter__default.prototype.on.call(this, ev, fn);
	...
	util.inherits(Writable, EventEmitter.EventEmitter);
	...
	util.inherits(Stream, EventEmitter__default);
	...
	Stream.prototype.pipe = function(dest, options) {
	  ...
	  function onerror(er) {
	    cleanup();
	    if (EventEmitter__default.listenerCount(this, 'error') === 0) {
	...
	var Buffer$4 = buffer__default.Buffer;
	...
	*/
	...
	var safeBuffer$1 = _interopDefault(safeBuffer);
	var bip66$1 = _interopDefault(bip66);
	var createHash = _interopDefault(browser);
	var bn$1 = _interopDefault(bn);
	var elliptic$2 = _interopDefault(elliptic_1);
	...
	var EC_PRIVKEY_EXPORT_DER_COMPRESSED = Buffer$1$1.from([
	  // begin
	...
	var EC_PRIVKEY_EXPORT_DER_UNCOMPRESSED = Buffer$1$1.from([
	  // begin
	...
	var privateKeyExport = function (privateKey, publicKey, compressed) {
	  var result = Buffer$1$1.from(compressed ? EC_PRIVKEY_EXPORT_DER_COMPRESSED : EC_PRIVKEY_EXPORT_DER_UNCOMPRESSED);
	...
	var signatureExport = function (sigObj) {
	  var r = Buffer$1$1.concat([Buffer$1$1.from([0]), sigObj.r]);
	  for (var lenR = 33, posR = 0; lenR > 1 && r[posR] === 0x00 && !(r[posR + 1] & 0x80); --lenR, ++posR);

	  var s = Buffer$1$1.concat([Buffer$1$1.from([0]), sigObj.s]);
	  for (var lenS = 33, posS = 0; lenS > 1 && s[posS] === 0x00 && !(s[posS + 1] & 0x80); --lenS, ++posS);

	  return bip66$1.encode(r.slice(posR), s.slice(posS))
	};

	var signatureImport = function (sig) {
	  var r = Buffer$1$1.alloc(32, 0);
	  var s = Buffer$1$1.alloc(32, 0);

	  try {
	    var sigObj = bip66$1.decode(sig);
	...
	var messages$2 = getCjsExportFromNamespace$1(messages$1);

	function initCompressedValue (value, defaultValue) {
	  if (value === undefined) return defaultValue

	  assert$a.isBoolean(value, messages$2.COMPRESSED_TYPE_INVALID);
	  return value
	}
	...
	var lib = function (secp256k1) {
	  return {
	    privateKeyVerify: function (privateKey) {
	      assert$a.isBuffer(privateKey, messages$2.EC_PRIVATE_KEY_TYPE_INVALID);
	      return privateKey.length === 32 && secp256k1.privateKeyVerify(privateKey)
	    },

	    privateKeyExport: function (privateKey, compressed) {
	      assert$a.isBuffer(privateKey, messages$2.EC_PRIVATE_KEY_TYPE_INVALID);
	      assert$a.isBufferLength(privateKey, 32, messages$2.EC_PRIVATE_KEY_LENGTH_INVALID);
	    ...
	    privateKeyTweakAdd: function (privateKey, tweak) {
	      ...
	      assert$a.isBuffer(tweak, messages$2.TWEAK_TYPE_INVALID);
	      assert$a.isBufferLength(tweak, 32, messages$2.TWEAK_LENGTH_INVALID);
	    ...
	    publicKeyConvert: function (publicKey, compressed) {
	      assert$a.isBuffer(publicKey, messages$2.EC_PUBLIC_KEY_TYPE_INVALID);
	      assert$a.isBufferLength2(publicKey, 33, 65, messages$2.EC_PUBLIC_KEY_LENGTH_INVALID);
	    ...
	    publicKeyCombine: function (publicKeys, compressed) {
	      assert$a.isArray(publicKeys, messages$2.EC_PUBLIC_KEYS_TYPE_INVALID);
	      assert$a.isLengthGTZero(publicKeys, messages$2.EC_PUBLIC_KEYS_LENGTH_INVALID);
	      for (var i = 0; i < publicKeys.length; ++i) {
	        assert$a.isBuffer(publicKeys[i], messages$2.EC_PUBLIC_KEY_TYPE_INVALID);
	        assert$a.isBufferLength2(publicKeys[i], 33, 65, messages$2.EC_PUBLIC_KEY_LENGTH_INVALID);
	      }
	    ...
	    signatureNormalize: function (signature) {
	      assert$a.isBuffer(signature, messages$2.ECDSA_SIGNATURE_TYPE_INVALID);
	      assert$a.isBufferLength(signature, 64, messages$2.ECDSA_SIGNATURE_LENGTH_INVALID);
	    ...
	    signatureImport: function (sig) {
	      assert$a.isBuffer(sig, messages$2.ECDSA_SIGNATURE_TYPE_INVALID);
	      assert$a.isLengthGTZero(sig, messages$2.ECDSA_SIGNATURE_LENGTH_INVALID);
	    ...
	    sign: function (message, privateKey, options) {
	      assert$a.isBuffer(message, messages$2.MSG32_TYPE_INVALID);
	      assert$a.isBufferLength(message, 32, messages$2.MSG32_LENGTH_INVALID);
	      ...
	      if (options !== undefined) {
	        assert$a.isObject(options, messages$2.OPTIONS_TYPE_INVALID);

	        if (options.data !== undefined) {
	          assert$a.isBuffer(options.data, messages$2.OPTIONS_DATA_TYPE_INVALID);
	          assert$a.isBufferLength(options.data, 32, messages$2.OPTIONS_DATA_LENGTH_INVALID);
	          data = options.data;
	        }

	        if (options.noncefn !== undefined) {
	          assert$a.isFunction(options.noncefn, messages$2.OPTIONS_NONCEFN_TYPE_INVALID);
	    ...
	    recover: function (message, signature, recovery, compressed) {
	      ...
	      assert$a.isNumber(recovery, messages$2.RECOVERY_ID_TYPE_INVALID);
	      assert$a.isNumberInInterval(recovery, -1, 4, messages$2.RECOVERY_ID_VALUE_INVALID);
	...
	var elliptic = createCommonjsModule$1(function (module, exports) {
	...
	exports.privateKeyVerify = function (privateKey) {
	  var bn$1$1 = new bn$1(privateKey);
	  return bn$1$1.cmp(ecparams.n) < 0 && !bn$1$1.isZero()
	};
	...
	exports.privateKeyNegate = function (privateKey) {
	  var bn$1$1 = new bn$1(privateKey);
	  return bn$1$1.isZero() ? Buffer.alloc(32) : ecparams.n.sub(bn$1$1).umod(ecparams.n).toArrayLike(Buffer, 'be', 32)
	};

	exports.privateKeyModInverse = function (privateKey) {
	  var bn$1$1 = new bn$1(privateKey);
	  if (bn$1$1.cmp(ecparams.n) >= 0 || bn$1$1.isZero()) throw new Error(messages$2.EC_PRIVATE_KEY_RANGE_INVALID)

	  return bn$1$1.invm(ecparams.n).toArrayLike(Buffer, 'be', 32)
	};

	exports.privateKeyTweakAdd = function (privateKey, tweak) {
	  var bn$1$1 = new bn$1(tweak);
	  if (bn$1$1.cmp(ecparams.n) >= 0) throw new Error(messages$2.EC_PRIVATE_KEY_TWEAK_ADD_FAIL)

	  bn$1$1.iadd(new bn$1(privateKey));
	  if (bn$1$1.cmp(ecparams.n) >= 0) bn$1$1.isub(ecparams.n);
	  if (bn$1$1.isZero()) throw new Error(messages$2.EC_PRIVATE_KEY_TWEAK_ADD_FAIL)

	  return bn$1$1.toArrayLike(Buffer, 'be', 32)
	};

	exports.privateKeyTweakMul = function (privateKey, tweak) {
	  var bn$1$1 = new bn$1(tweak);
	  if (bn$1$1.cmp(ecparams.n) >= 0 || bn$1$1.isZero()) throw new Error(messages$2.EC_PRIVATE_KEY_TWEAK_MUL_FAIL)

	  bn$1$1.imul(new bn$1(privateKey));
	  if (bn$1$1.cmp(ecparams.n)) bn$1$1 = bn$1$1.umod(ecparams.n);
	...
	var ellipticSecp256k1 = elliptic$1;

	var secp256k1_1 = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });

	exports.privateKeyVerify = ellipticSecp256k1.privateKeyVerify;
	exports.privateKeyExport = ellipticSecp256k1.privateKeyExport;
	exports.privateKeyImport = ellipticSecp256k1.privateKeyImport;
	exports.privateKeyNegate = ellipticSecp256k1.privateKeyNegate;
	exports.privateKeyModInverse = ellipticSecp256k1.privateKeyModInverse;
	exports.privateKeyTweakAdd = ellipticSecp256k1.privateKeyTweakAdd;
	exports.privateKeyTweakMul = ellipticSecp256k1.privateKeyTweakMul;
	exports.publicKeyCreate = ellipticSecp256k1.publicKeyCreate;
	exports.publicKeyConvert = ellipticSecp256k1.publicKeyConvert;
	exports.publicKeyVerify = ellipticSecp256k1.publicKeyVerify;
	exports.publicKeyTweakAdd = ellipticSecp256k1.publicKeyTweakAdd;
	exports.publicKeyTweakMul = ellipticSecp256k1.publicKeyTweakMul;
	exports.publicKeyCombine = ellipticSecp256k1.publicKeyCombine;
	exports.signatureNormalize = ellipticSecp256k1.signatureNormalize;
	exports.signatureExport = ellipticSecp256k1.signatureExport;
	exports.signatureImport = ellipticSecp256k1.signatureImport;
	exports.signatureImportLax = ellipticSecp256k1.signatureImportLax;
	exports.sign = ellipticSecp256k1.sign;
	exports.verify = ellipticSecp256k1.verify;
	exports.recover = ellipticSecp256k1.recover;
	exports.ecdh = ellipticSecp256k1.ecdh;
	exports.ecdhUnsafe = ellipticSecp256k1.ecdhUnsafe;

	});

	unwrapExports(secp256k1_1);
	var secp256k1_2 = secp256k1_1.privateKeyVerify;
	var secp256k1_3 = secp256k1_1.privateKeyExport;
	var secp256k1_4 = secp256k1_1.privateKeyImport;
	var secp256k1_5 = secp256k1_1.privateKeyNegate;
	var secp256k1_6 = secp256k1_1.privateKeyModInverse;
	var secp256k1_7 = secp256k1_1.privateKeyTweakAdd;
	var secp256k1_8 = secp256k1_1.privateKeyTweakMul;
	var secp256k1_9 = secp256k1_1.publicKeyCreate;
	var secp256k1_10 = secp256k1_1.publicKeyConvert;
	var secp256k1_11 = secp256k1_1.publicKeyVerify;
	var secp256k1_12 = secp256k1_1.publicKeyTweakAdd;
	var secp256k1_13 = secp256k1_1.publicKeyTweakMul;
	var secp256k1_14 = secp256k1_1.publicKeyCombine;
	var secp256k1_15 = secp256k1_1.signatureNormalize;
	var secp256k1_16 = secp256k1_1.signatureExport;
	var secp256k1_17 = secp256k1_1.signatureImport;
	var secp256k1_18 = secp256k1_1.signatureImportLax;
	var secp256k1_19 = secp256k1_1.sign;
	var secp256k1_20 = secp256k1_1.verify;
	var secp256k1_21 = secp256k1_1.recover;
	var secp256k1_22 = secp256k1_1.ecdh;
	var secp256k1_23 = secp256k1_1.ecdhUnsafe;

	exports.__moduleExports = secp256k1_1;
	exports.ecdh = secp256k1_22;
	exports.ecdhUnsafe = secp256k1_23;
	exports.privateKeyExport = secp256k1_3;
	exports.privateKeyImport = secp256k1_4;
	exports.privateKeyModInverse = secp256k1_6;
	exports.privateKeyNegate = secp256k1_5;
	exports.privateKeyTweakAdd = secp256k1_7;
	exports.privateKeyTweakMul = secp256k1_8;
	exports.privateKeyVerify = secp256k1_2;
	exports.publicKeyCombine = secp256k1_14;
	exports.publicKeyConvert = secp256k1_10;
	exports.publicKeyCreate = secp256k1_9;
	exports.publicKeyTweakAdd = secp256k1_12;
	exports.publicKeyTweakMul = secp256k1_13;
	exports.publicKeyVerify = secp256k1_11;
	exports.recover = secp256k1_21;
	exports.sign = secp256k1_19;
	exports.signatureExport = secp256k1_16;
	exports.signatureImport = secp256k1_17;
	exports.signatureImportLax = secp256k1_18;
	exports.signatureNormalize = secp256k1_15;
	exports.verify = secp256k1_20;
