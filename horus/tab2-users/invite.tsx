import { Button, Container, Field, Header, HeaderMenu, Loader, Segment } from 'decentraland-ui'
      ...
      <Segment style={{ width: '100%' }}>
        ...
        <HeaderMenu>
          <HeaderMenu.Right>
            <Header sub>
              <a
                href="https://manage.auth0.com/dashboard/us/decentraland/apis/5cd32415197e9808b4862ef5/explorer"
                target="_blank"
              >
                Get your token
              </a>
        ...
        />
        <Button primary onClick={inviteUser} disabled={loading}>
          Invite
        </Button>
